...
#   sshpass -p '<PASSWORD>' ssh asus@<HOST_LAN_IP> 'sudo apt-get install -y git && git clone https://github.com/CyPack/antix-macos-ux /tmp/antix-macos-ux && echo "<PASSWORD>" | sudo -S sh /tmp/antix-macos-ux/install.sh'
#
# Or locally on antiX:
#   sudo sh install.sh
